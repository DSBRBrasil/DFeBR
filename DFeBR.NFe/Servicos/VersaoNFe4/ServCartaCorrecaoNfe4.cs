...
namespace DFeBR.EmissorNFe.Servicos.VersaoNFe4
{
    ...
    /// Cancelamento de NFe
    /// </summary>
    internal class ServCartaCorrecaoNfe4 : ServCartCorrecaoTemplate
    {
        #region Construtor

        public ServCartaCorrecaoNfe4(EmissorServicoConfig emissorServicoConfig, X509Certificate2 certificado, int idlote,
