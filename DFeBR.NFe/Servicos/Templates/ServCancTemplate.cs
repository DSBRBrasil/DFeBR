...
{
    /// <summary>
    /// Template de Cancelameto de NFe
    /// </summary>
    public abstract class ServCancTemplate : IServCancTemplate
    {
        ...
        /// </summary>
        /// <returns></returns>
        public string ObterXmlCompletamenteFormado()
        {
            ...
            try
            {
                ...
                if (_emisorEmissorServicoConfig.ValidarSchema)
                    ValidarSchema(d1);
                var str = Utils.ClasseParaXmlString(d1);
                return str;
            }
            catch (Exception)
            {
        ...
        {
            return _emisorEmissorServicoConfig.ConfigEnderecoServico.UrlsWsdl.Cancelar;
        }
            ...
            foreach (var item in _eventosBuilder)
                lstEventos.Add(new evento
                {
                        ...
                        infEvento = new infEventoEnv
                        {
                                ...
                                tpEvento = numeroEvento, //Codigo do evento de cancelamento
        ...
        private ICollection<string> ObterListaNomeSchemas()
        {
            ...
            var arqs = _emisorEmissorServicoConfig.ConfigEnderecoServico.Schemas.Cancelar.ToList();
        ...
        public IRetCancelar Executar()
        {
            ...
            if (retorno1.retEvento.Any(n => n.infEvento != null))
                if (StatusSefaz.ListarCodigo.All(n => retorno1.retEvento.All(k => k.infEvento.cStat != n.Key)))
                    _rejeitadas++;
            var retorno2 = new RetCancelar(retorno1, node, _processadas, _rejeitadas, xmlEnviado, _urlServico, _urlWsdlServico,
                    NomeServico);
