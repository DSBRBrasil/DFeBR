...
{
    public class RetConsProt : IRetConsProt
    {
        #region Propriedades

        public retConsSitNFe Retorno { get; set; }
        ...
        public RetConsProt(retConsSitNFe retorno, string xmlRecebido, int processadas, int rejeitadas, string xmlEnviado, string urlServico,
