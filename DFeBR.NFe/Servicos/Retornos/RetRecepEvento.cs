...
{
    public class RetRecepEvento : IRetRecepEvento

    {
        ...
        public RetRecepEvento()
        {
        }

        public RetRecepEvento(retEnvEvento retorno, string xmlRecebido, int processadas, int rejeitadas, string xmlEnviado, string urlServico,
