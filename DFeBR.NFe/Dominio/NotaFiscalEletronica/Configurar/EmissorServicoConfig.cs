...
namespace DFeBR.EmissorNFe.Dominio.NotaFiscalEletronica.Configurar
{
    ...
    public sealed class EmissorServicoConfig
    {
        ...
        /// </summary>
        public string DiretorioArquivoConfiguracao { get; }

        /// <summary>
        ///     Indicador de sincronização de serviço
        ///     <para>Indica o tipo de serviço utilizado para o envio de NFe</para>
        /// </summary>
        public IndicadorSincronizacao IndicadorSincronizacao { get; }
        ...
        /// <summary>
        ///     Habilitar a criação de arquivo de Log
        /// </summary>
        ...
        /// </summary>
        public ConfigServ ConfigEnderecoServico { get; private set; }
        ...
        /// <param name="estado">Estado do Emitente</param>
        /// <param name="ambiente">Ambiente do Serviço</param>
        /// <param name="indicadorSincronizacao">IIndicador de Sincronização</param>
        /// <param name="timeOut">Tempo de Espera</param>
        /// <param name="caminhoConfig">Caminho do arquivo de configuração emissorsettings.json</param>
                ...
                string caminhoConfig = "")
        {
            ...
            Ambiente = ambiente;
            TimeOut = timeOut;
            DiretorioArquivoConfiguracao = caminhoConfig;
        ...
        {
            ConfigEnderecoServico = configServ;
        }
        ...
        {
            var nomeArq = "emissorsettings.json";
            try
            {
                var localArq = "";
                if (string.IsNullOrWhiteSpace(DiretorioArquivoConfiguracao))
                    localArq = $@"{Environment.CurrentDirectory}";
                else
                    localArq = DiretorioArquivoConfiguracao;
                var arq = Utils.LerArquivo(localArq, nomeArq);
                var arqConfig = (ConfigServ) Utils.JsonDeserialize<ConfigServ>(arq);
                ConfigEnderecoServico = arqConfig;
            }
            catch (Exception ex)
            {
        ...
        private void ValidaEmitente()
        {
            ...
            if (string.IsNullOrEmpty(Emitente.xFant) || string.IsNullOrEmpty(Emitente.xNome))
                throw new FalhaValidacaoException("A razão social (xNome) e nome fantasia (xNome) do emitente são obrigatórios");
        ...
        /// <param name="signatureMethodSignedXML">Algoritmo de Assinatura</param>
        /// <param name="digestMethodReference">URI para DigestMethod na Classe Reference para auxiliar para a assinatura</param>
        public void ConfiguraCertificadoA1ByteArray(byte[] byteArrayCertificado,string senha,
                string signatureMethodSignedXML = "http://www.w3.org/2000/09/xmldsig#rsa-sha1",
                string digestMethodReference = "http://www.w3.org/2000/09/xmldsig#sha1")
        {
            if (Certificado != null)
