...
namespace DFeBR.EmissorNFe.Dominio.NotaFiscalEletronica.Enderecador
{
    ...
    public class UrlWsdl
    {
        ...
        /// <summary>
        ///     Endereço url do serviços de Recepciona Evento
        /// </summary>
        [JsonProperty("recebeEvento")]
        public string RecebeEvento { get; set; }
    ...
    public class Schema
    {
        ...
        /// <summary>
        ///      Endereço schema do serviços de Inutilização
        /// </summary>
        [JsonProperty("inutiliza")]
        public List<string> Inutiliza { get; set; }

        /// <summary>
        ///      Endereço schema do serviços de Consulta Recibo
        /// </summary>
        [JsonProperty("consultaRecibo")]
        ...
        /// <summary>
        ///     Endereço schema do serviços de Carta de Correção
        /// </summary>
        [JsonProperty("cartaCorrecao")]
        public List<string> CartaCorrecao { get; set; }
