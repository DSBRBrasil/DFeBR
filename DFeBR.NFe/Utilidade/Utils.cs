    ...
    public static class Utils
    {
        ...
        public static string FormatarCnpj(string str)
        {
            try
            {
                ...
                return string.IsNullOrWhiteSpace(str2) ? "" : Convert.ToUInt64(str2).ToString(@"00\.000\.000\/0000\-00");
            }
            catch (Exception)
            {
                return "";
        ...
        public static void VerificaValidade(this X509Certificate2 x509Certificate2)
        {
            ...
            if (dataExpiracao <= Utils.ObterDataBrasil())
        ...
        public static string FormatarPesoDanfe(string value)
        {
