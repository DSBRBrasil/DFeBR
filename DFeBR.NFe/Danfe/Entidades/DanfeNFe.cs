...
namespace DFeBR.EmissorNFe.Danfe.Entidades
{
    public class DanfeNFe
    {
        ...
        public DanfeNFe(NFe nfe, Status status,string protocolo, string creditos, Issqn issqn=null)
        {
            ...
            var enderecoEmit = new Endereco(nfe.infNFe.emit.enderEmit.xLgr, nfe.infNFe.emit.enderEmit.xBairro, 
                    ...
                    nfe.infNFe.emit.enderEmit.UF, nfe.infNFe.emit.enderEmit.fone.ToString(), nfe.infNFe.emit.enderEmit.UF);
            ...
            if (nfe.infNFe.transp?.transporta != null)
            {
                ...
                if (nfe.infNFe.transp.vol!=null)
                {
                    ...
                    {
                        Volumes.Add(new Volume(item.qVol, item.esp, item.pesoB ?? 0, item.pesoL ?? 0, item.marca) );
                    }
            ...
            Imposto = new Imposto(nfe.infNFe.total.ICMSTot.vBC, nfe.infNFe.total.ICMSTot.vICMS, nfe.infNFe.total.ICMSTot.vBCST,
                    nfe.infNFe.total.ICMSTot.vICMSUFDest, nfe.infNFe.total.ICMSTot.vProd, nfe.infNFe.total.ICMSTot.vFrete,
                    nfe.infNFe.total.ICMSTot.vSeg, nfe.infNFe.total.ICMSTot.vDesc, nfe.infNFe.total.ICMSTot.vOutro,
                    nfe.infNFe.total.ICMSTot.vIPI, nfe.infNFe.total.ICMSTot.vNF);
            ...
            TipoOper = nfe.infNFe.ide.tpNF == TipoNFe.Entrada ? "0" : "1";
